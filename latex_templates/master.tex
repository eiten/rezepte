...
% -- Layout & Tables --
\usepackage[left=2cm, right=2cm, top=1.5cm, bottom=1.5cm, includehead, includefoot]{geometry}
...
\ifoot[\footnotesize https://rezepte.iten.pro]{\footnotesize https://rezepte.iten.pro}
